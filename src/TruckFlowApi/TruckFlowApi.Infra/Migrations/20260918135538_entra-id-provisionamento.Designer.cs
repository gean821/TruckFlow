...
namespace TruckFlowApi.Infra.Migrations
{
    ...
    [Migration("20260918135538_entra-id-provisionamento")]
    partial class entraidprovisionamento
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TruckFlow.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EmpresaId", "EntityName", "EntityId");
            ...
            modelBuilder.Entity("TruckFlow.Domain.Entities.CodigoVerificacaoEmail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UsuarioId", "Finalidade", "UsadoEm");

                    b.ToTable("CodigoVerificacaoEmail", (string)null);
                });
            ...
            modelBuilder.Entity("TruckFlow.Domain.Entities.EntraGroupRoleMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("EntraGroupNome")
                        .IsRequired()
                        .HasMaxLength(128)
                    ...
                    b.ToTable("EntraGroupRoleMapping", (string)null);
                });
            ...
            modelBuilder.Entity("TruckFlow.Domain.Entities.NotaFiscal", b =>
                {
                    ...
                    b.Property<DateTime?>("UltimaValidacaoSefaz")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("TruckFlow.Domain.Entities.RecebimentoEvento", b =>
                {
                    ...
                    b.HasIndex("EmpresaId", "ItemPlanejamentoId")
            ...
            modelBuilder.Entity("TruckFlow.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<DateTime?>("UltimoSyncEntraEm")
                        .HasColumnType("timestamp with time zone");
